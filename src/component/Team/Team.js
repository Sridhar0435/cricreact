        ...
        {player !== "" ? (
          <section className="teamSection">
            <article className="teamArticle">
              <div className="row">
                <div className="col l12 s12 titl">
                  {" "}
                  <span className="htn">
              ...
              <div className="row row_select">
                <div className="col l3 s12">
                  <h6 className="selectplayer">Select player</h6>
                  <select
                    className="ul1_team selectTeam"
                    onChange={(index) => this.passIndex(index)}
                  >
                    {player !== ""
                  ...
                  <div className="figDiv">
                    {player !== "" ? (
                      <>
                        ...
                        <figure>
                          <h3 className="pName">
                            {players[this.state.id].fullName}
                          </h3>
                          <img
                            src={players[this.state.id].imageURL}
                            width="300px"
                            alt=""
                          />
                          <ul className="ul_p">
                            <li className="li_p">
                              Name : {players[this.state.id].fullName}
                            </li>
                            <li className="li_p">
                              D.O.B :{" "}
                              {players[this.state.id].hasOwnProperty("dob")
                                ? players[this.state.id].dob.replace(
                                    /T00:00:00Z/g,
                                    ""
                                  )
                                : ""}
                            ...
                            <li className="li_p">
                              Bowling Style :{" "}
                              {players[this.state.id].bowlingStyle}
                            </li>
                            <li className="li_p">
                              Batting Style :{" "}
                              {players[this.state.id].battingStyle}
                            </li>
                            <li className="li_p">
                              Player Type : {players[this.state.id].playerType}
                            </li>
                            <li className="li_p">
                              Test Debute :{" "}
                              {players[this.state.id].hasOwnProperty(
                                "testDebutDate"
                              )
                                ? players[this.state.id].testDebutDate.replace(
                                    /T00:00:00Z/g,
                                    ""
                                  )
                                : ""}
                            ...
                            <li className="li_p">
                              ...
                              {players[this.state.id].hasOwnProperty(
                                ...
                                ? players[this.state.id].odiDebutDate.replace(
                                    /T00:00:00Z/g,
                                    ""
                                  )
                                : ""}
                            ...
                            <li className="li_p">
                              ...
                              {players[this.state.id].hasOwnProperty(
                                ...
                                ? players[this.state.id].t20DebutDate.replace(
                                    /T00:00:00Z/g,
                                    ""
                                  )
                                : ""}
                        ...
                        <div className="bio">
                          {players[this.state.id].hasOwnProperty("bio")
                            ? players[this.state.id].bio
                                .replace(/(<([^>]+)>)/gi, "")
                                .split(".")
                                .map((item, index) => (
                                  <p className="b_p_l" key={index}>
                                    {index + 1 + ". " + item}
                                  </p>
                                ))
                            : ""}
